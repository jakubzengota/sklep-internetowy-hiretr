    ...
    return (
        <React.Fragment>
            ...
            <div style={{ margin: "auto", width: "60%", fontFamily: 'Cinzel'}}>
                ...
                Poniżej znajduje się numer rachunku, na który należy wpłacić 59,99 PLN
                <hr></hr>
                <p style={{fontFamily: 'Cinzel', fontSize: '15px'}}>Dane odbiorcy:</p> 
                Hiretr sp. z o.o.<br></br>
                ul. Koszulkowa 23, 34-078 Koszulkowo
                <p style={{fontFamily: 'Cinzel', fontSize: '15px'}}>Bank:</p> 
                BRE BANK SA O/REG. w Koszulkowie
                <p style={{fontFamily: 'Cinzel', fontSize: '15px'}}>Numer rachunku:</p> 
                PL 98114011243630010353035239
                <p style={{fontFamily: 'Cinzel', fontSize: '15px'}}>Tytuł przelewu:</p> 
                (id:43454534) Hiretr Sklep 
                <p style={{fontFamily: 'Cinzel', fontSize: '15px'}}>Kwota:</p> 
                59,99 PLN
                <hr></hr>
